        ...
        <>
            <s.ContentListDiv width='800px;' marginLeft='580px'>
                ...
                <s.TableList width='800px' textAlign='left'>
                    <thead>
                        <s.TableTextTh width='150px'></s.TableTextTh><s.TableTextTh width='650px'></s.TableTextTh>
                    </thead>
                    <tbody>
                        ...
                        <s.TrStyle><s.TableTextTd>내용 *</s.TableTextTd><s.TableTextTd><s.TextareaStyle rows={4} cols={79}/></s.TableTextTd></s.TrStyle>
                    </tbody>
                </s.TableList>
                <s.ButtonDiv>
