    ...
    return (
        <>
            <s.ContentListDiv>
                ...
                <s.ButtonDiv>
                    <s.ButtonInnerDiv className="w-16" float='right'>
                        <Select label="지역">
                    ...
                    <s.SearchDiv width='200px' float='right'>
                ...
                <s.TableList textAlign='center'>
                    ...
                    <tbody>
                        ...
                        <s.TableTextTd width='160px'>SE2019050150</s.TableTextTd>
                            <s.TableTextTd width='160px'>서울한국외대점</s.TableTextTd>
                            <s.TableTextTd width='500px'>서울특별시 동대문구 이문로 119</s.TableTextTd>
                            <s.TableTextTd width='160px'><s.ButtonStyle width="100px"><Link to="/">복원하기</Link></s.ButtonStyle></s.TableTextTd>
                        </s.TableTextTr>
                        <s.TableTextTr height='45px'>
                        <s.TableTextTd width='160px'>SE2019050150</s.TableTextTd>
                            <s.TableTextTd width='160px'>서울한국외대점</s.TableTextTd>
