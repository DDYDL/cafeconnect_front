          ...
          <div className={`${styles["MenuDetail"]} ${styles["screen"]}`}>
            ...
            <div className={styles["background"]}>
              ...
              <div className={styles["flex-row-1"]}>
                <img
                  className={styles["x384x530cropjpg"]}
                  src={menu.imageUrl}
                  alt="image"
                ></img>
                <div className={styles["overlap-group3"]}>
                  ...
                  >
                    ...
                    <div className={styles["table-body-item"]}>
                      ...
                      >
                        <div
                          className={`${styles["text-2"]} ${styles["valign-text-middle"]}`}
                          style={{ width: "250px" }}
                        >
                    ...
                    <div className={styles["table-body-item"]}>
                      ...
                      >
                        <div
                          className={`${styles["x500ml"]} ${styles["valign-text-middle"]}`}
                          style={{ width: "250px" }}
                        >
                          {menu.menuCapacity}
                        </div>
                    ...
                    <div className={styles["table-body-item"]}>
                      ...
                      >
                        <div
                          className={`${styles["x300kcal"]} ${styles["valign-text-middle"]}`}
                          style={{ width: "250px" }}
                        >
                          {menu.calories}
                        </div>
                    ...
                    <div
                      className={`${styles["table-body-item"]} ${styles["notosanskr-medium-black-16px"]}`}
                    >
                      <div
                        className={`${styles["data-2"]} ${styles["valign-text-middle"]}`}
                      >
              ...
              <div className={styles["frame-101"]}>
                <div className={styles["frame-99"]}>
                  <div className={styles["frame-97"]}>
                    <div
                      className={`${styles["text-14"]} ${styles["valign-text-middle"]} ${styles["notosanskr-medium-black-16px"]}`}
                    >
                      카테고리
                    </div>
                  </div>
                  <div className={styles["frame-98"]}>
                    ...
                    >{`${menu.menuCategoryName}`}</div>
                  </div>
                </div>
                <div className={styles["frame-100"]}>
                  <div className={styles["frame-97"]}>
                    <div
                      className={`${styles["text-16"]} ${styles["valign-text-middle"]} ${styles["notosanskr-medium-black-16px"]}`}
                    >
                      원산지
                    </div>
                  </div>
