    ...
    <>
      <m.CarouselDiv>
        ...
        <div className={styles['container-center-horizontal']}>
          <div className={`${styles['MenuListCopy']} ${styles['screen']}`}>
            <div className={styles['background']}>
              <div className={`${styles['heading-2']} ${styles['valign-text-middle']}`}>메뉴 목록</div>
              <div className={`${styles['text-59']} ${styles['valign-text-middle']}`}>총102건</div>
              <div className={`${styles['flex-row']} ${styles['flex']}`}>
                ...
                {/* <div className={styles['frame-104']}>
                  <div className={styles['frame-105']}>
                    <div className={`${styles['text-55']} ${styles['valign-text-middle']}`}>분류</div>
                  </div>
                  <img
                ...
                <div className={styles['frame-107']}>
                  <div className={`${styles['text-56']} ${styles['valign-text-middle']}`}>검색</div>
                ...
                <div className={styles['frame-92']}>
                  <div className={styles['frame-87']}>
                    ...
                    <div className={styles['cell']}>
                      <div className={`${styles['text-1']} ${styles['valign-text-middle']} ${styles['notosanskr-medium-shark-16px']}`}>
                        용량
                      </div>
                    </div>
                    <div className={styles['cell']}>
                    ...
                    <div className={styles['cell']}>
                      <div className={`${styles['text-14']} ${styles['valign-text-middle']} ${styles['notosanskr-medium-shark-16px']}`}>
                        나트륨
                      </div>
                    </div>
                  </div>
                  <div className={styles['frame']}>
                    ...
                    <div className={`${styles['data-1']} ${styles['data-4']}`}>
                      <div className={styles['frame-91']}>
                        ...
                        <div className={styles['frame-89']} onClick={() => (navigate('/mainMenuDetail/1'))}>
                    ...
                    <div className={`${styles['data-3']} ${styles['data-4']}`}>
                      <div className={`${styles['text-18']} ${styles['valign-text-middle']} ${styles['notosanskr-light-shark-16px']}`}>
                        -
                      </div>
                    </div>
                    <div className={`${styles['data-3']} ${styles['data-4']}`}>
              ...
              {/* <div className={`${styles['flex-row-1']} ${styles['flex-row-3']}`}>
                ...
                <div className={`${styles['component-3']} ${styles['component']}`}>
                  <div className={`${styles['text-11']} ${styles['valign-text-middle']} ${styles['montserrat-light-pumice-16px']}`}>2</div>
                </div>
                <div className={`${styles['component-4']} ${styles['component']}`}>
                  <div className={`${styles['text-4']} ${styles['valign-text-middle']} ${styles['montserrat-light-pumice-16px']}`}>3</div>
                </div>
                <div className={`${styles['component-5']} ${styles['component']}`}>
                  <div className={`${styles['text-13']} ${styles['valign-text-middle']} ${styles['montserrat-light-pumice-16px']}`}>4</div>
                </div>
                <div className={styles['overlap-group3']}>
                  <div className={`${styles['component-1']} ${styles['component']}`}>
                    <div className={`${styles['text-4']} ${styles['valign-text-middle']} ${styles['montserrat-light-pumice-16px']}`}>5</div>
                  </div>
                  <div className={styles['border-1']}>
                    <img className={styles['image']} src={require("../assets/img/image@2x.png")} alt="Image" />
                  </div>
                </div>
              </div> */}
              <div className={styles['button']} onClick={() => (navigate('/menuInsert'))}>
                <div className={styles['overlap-group-1']}>
                  <div className={`${styles['text-57']} ${styles['valign-text-middle']}`}>메뉴 등록</div>
                  <div className={styles['small-btn_brown']}>
                    <div className={`${styles['text-58']} ${styles['valign-text-middle']} ${styles['themewagongithubiosemanticheading-6']}`}>
                      메뉴등록
                    </div>
                  </div>
                </div>
              ...
              <div className={styles['footer-contents']}>
                <div className={`${styles['flex-row-2']} ${styles['flex-row-3']}`}>
                  <div className={`${styles['flex-col']} ${styles['flex']}`}>
                    <div className={styles['overlap-group-2']}>
                      ...
                      <div className={`${styles['text-60']} ${styles['valign-text-middle']}`}>
                        사업자정보확인
                      </div>
                      <p className={`${styles['text-61']} ${styles['valign-text-middle']} ${styles['notosanskr-light-coconut-12px']}`}>
                ...
                <div className={styles['flex-col-1']}>
                  ...
                  <div className={styles['text-container']}>
                    <div className={`${styles['text-62']} ${styles['valign-text-middle']} ${styles['notosanskr-light-coconut-12px']}`}>
                      보상대상 : 미배송/반품, 환불거부/쇼핑몰부도
                    </div>
                    <div className={`${styles['text-63']} ${styles['valign-text-middle']}`}>
                      서비스 가입사실 확인
                    </div>
                  </div>
                </div>
