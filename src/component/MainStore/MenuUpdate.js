                    ...
                    <div className={`${styles['MenuUpdate']} ${styles['screen']}`}>
                        <div className={styles['background']}>
                            ...
                            <div className={styles['form']}>
                                <div className={`${styles['flex-col']} ${styles['flex']}`}>
                                    ...
                                    <div className={`${styles['input-1']} ${styles['input-4']}`}>
                                        <div className={`${styles['label-1']} ${styles['valign-text-middle']} ${styles['notosanskr-bold-black-16px']}`}>
                                            이미지 등록
                                        </div>
                                        <div className={styles['border-1']}>
                                            ...
                                            />
                                            <div className={`${styles['text-20']} ${styles['valign-text-middle']} ${styles['themewagongithubiosemanticitem']}`}>
                                                <span>
                                ...
                                <div className={styles['container-container']}>
                                    <div className={styles['container']}>
                                        ...
                                        <div className={`${styles['input-2']} ${styles['input-4']}`}>
                                            <div className={`${styles['text-14']} ${styles['valign-text-middle']} ${styles['notosanskr-light-pink-swan-15px']}`}>
                                                메뉴&nbsp;&nbsp;코드를 입력하세요
                                            </div>
                                        </div>
                                    </div>
                            ...
                            <div className={styles['small-btn_brown']}>
                                <div className={`${styles['text-21']} ${styles['valign-text-middle']} ${styles['themewagongithubiosemanticheading-6']}`}>
                                    메뉴 수정
                                </div>
                            </div>
                        </div>
