          ...
          <div className={`${styles['category']} ${styles['screen']}`}>
            ...
            <div className={styles['frame-container']}>
              <div className={styles['frame-293']}>
                <div className={`${styles['text-3']} ${styles['valign-text-middle']} ${styles['notosanskr-medium-black-12px']}`}>
                  대분류
                </div>
              </div>
            ...
            <div className={styles['overlap-group2']}>
              ...
              <div className={styles['view-3']}>
                ...
                <div className={`${styles['frame-301-2']} ${styles['frame-301-3']}`}>
                  <div className={styles['frame-299']}>
                    <div className={`${styles['text-34']} ${styles['valign-text-middle']} ${styles['notosanskr-light-black-16px']}`}>
                      원두
                    </div>
                  </div>
                  <img className={styles['frame-300']} src={frame_300} alt="Frame 300" />
              ...
              <img className={styles['plus-circle-outline']} src={plus} alt="plus-circle-outline" />
              <img className={styles['minus-circle-outline']} src={minus} alt="minus-circle-outline" />
              <img className={`${styles['plus-circle-outline-1']} ${styles['plus-circle-outline-3']}`} src={plus} alt="plus-circle-outline" />
              <img className={`${styles['minus-circle-outline-1']} ${styles['minus-circle-outline-3']}`} src={minus} alt="minus-circle-outline" />
              <img className={`${styles['plus-circle-outline-2']} ${styles['plus-circle-outline-3']}`} src={plus} alt="plus-circle-outline" />
              <img className={`${styles['minus-circle-outline-2']} ${styles['minus-circle-outline-3']}`} src={minus} alt="minus-circle-outline" />

            </div>
            <div className={styles['flex-row']}>
              <img className={styles['circle-small']} src={circle_small} alt="circle-small" />
              <div className={`${styles['text-45']} ${styles['valign-text-middle']}`}>선택한 대분류 카테고리</div>
            </div>
            <div className={styles['frame-309']}>
              <div className={`${styles['frame-310']} ${styles['notosanskr-light-black-16px']}`}>
                <div className={`${styles['text-40']} ${styles['valign-text-middle']}`}>
                  커피자재&gt;원두&gt;카페인
                </div>
                <div className={`${styles['text-41']} ${styles['valign-text-middle']}`}>
                  커피자재&gt;원두&gt;디카페인
                </div>
                <div className={`${styles['text-42']} ${styles['valign-text-middle']}`}>
                  커피자재&gt;원두&gt;기타
                </div>
                <div className={`${styles['text-43']} ${styles['valign-text-middle']}`}>커피자재&gt;콜드부르</div>
                <div className={`${styles['text-44']} ${styles['valign-text-middle']}`}>커피자재&gt;기타</div>
              </div>
            </div>
              ...
              <div className={styles['footer-contents']}>
                <div className={styles['flex-row-1']}>
                  <div className={`${styles['flex-col-1']} ${styles['flex-col-3']}`}>
                    <div className={styles['overlap-group-1']}>
                      ...
                      <div className={`${styles['text-9']} ${styles['valign-text-middle']}`}>사업자정보확인</div>
                      <p className={`${styles['text-10']} ${styles['valign-text-middle']} ${styles['notosanskr-light-coconut-12px']}`}>
                ...
                <div className={`${styles['flex-col-2']} ${styles['flex-col-3']}`}>
                  ...
                  <div className={styles['text-container']}>
                    <div className={`${styles['text-11']} ${styles['valign-text-middle']} ${styles['notosanskr-light-coconut-12px']}`}>
