...
function ItemDetail() {
    ...
    const fetchData = async () => {
        try {
          setLoading(true); 
          const response = await axios.get(`http://localhost:8080/selectItemByItemCode/${itemCode}`); 
      ...
      const deleteData = async () => {
        try {
          ...
          const response = await axios.get(`http://localhost:8080/deleteItem/${itemCode}`); 
                ...
                <div className={styles['container-center-horizontal']}>
                    <div className={`${styles['ItemDetail']} ${styles['screen']}`}>
                        ...
                        <div className={styles['background']}>
                            ...
                            <img className={styles['x1ac11794-378f-404e-a96e-845e1444f16cjpg']} src={item.imageUrl} alt='image'></img>
                            <div className={`${styles['flex-col']} ${styles['flex']}`}>
                                <p className={`${styles['heading-3']} ${styles['valign-text-middle']}`}>
                                    {item.itemName}
                                </p>
                                <div className={`${styles['table-body']} ${styles['notosanskr-medium-black-16px']}`} style={{"width":"400px"}}>
                                    ...
                                    <div className={styles['table-body-item']}>
                                        ...
                                        <div className={`${styles['data-1']} ${styles['data-5']}`} style={{"width":"250px"}}>
                                            <div className={`${styles['g2000002676']} ${styles['valign-text-middle']}`} style={{"width":"250px"}}>상품코드</div>
                                        </div>
                                    </div>
                                    <div className={styles['table-body-item']}>
                                        <div className={`${styles['data']} ${styles['valign-text-middle']}`}>공급가</div>
                                        <div className={`${styles['data-1']} ${styles['data-5']}`} style={{"width":"250px"}}>
                                            <div className={`${styles['text-14']} ${styles['valign-text-middle']}`} style={{"width":"250px"}}>15000</div>
                                        </div>
                                    </div>
                                    <div className={styles['table-body-item']}>
                                        <div className={`${styles['data']} ${styles['valign-text-middle']}`}>단위</div>
                                        <div className={`${styles['data-1']} ${styles['data-5']}`} style={{"width":"250px"}}>
                                            <div className={`${styles['x1ea']} ${styles['valign-text-middle']}`} style={{"width":"250px"}}>{item.itemUnit}</div>
                                        </div>
                                    </div>
                                    <div className={styles['table-body-item']}>
                                        <div className={`${styles['data']} ${styles['valign-text-middle']}`}>보관상태</div>
                                        <div className={`${styles['data-1']} ${styles['data-5']}`} style={{"width":"250px"}}>
                                            <div className={`${styles['text-15']} ${styles['valign-text-middle']}`} style={{"width":"250px"}}>{item.itemStorage}</div>
                                        </div>
                                    </div>
                                    <div className={styles['table-body-item']}>
                                        <div className={`${styles['data']} ${styles['valign-text-middle']}`}>용량</div>
                                        <div className={`${styles['data-3']} ${styles['data-5']}`} style={{"width":"250px"}}>
                                            <div className={`${styles['x10kg']} ${styles['valign-text-middle']}`} style={{"width":"250px"}}>{item.itemCapacity}</div>
                                        </div>
                                    </div>
                                    <div className={styles['table-body-item']}>
                                        <div className={`${styles['data']} ${styles['valign-text-middle']}`}>규격</div>
                                        <div className={`${styles['data-4']} ${styles['data-5']}`} style={{"width":"250px"}}>
                                            <div className={`${styles['text-16']} ${styles['valign-text-middle']}`} style={{"width":"250px"}}>{item.itemStandard}</div>
                                        </div>
                                    </div>
                                    <div className={styles['table-body-item']}>
                                        <div className={`${styles['data']} ${styles['valign-text-middle']}`}>단위수량</div>
                                        <div className={`${styles['data-1']} ${styles['data-5']}`} style={{"width":"250px"}}>
                                            <div className={`${styles['number']} ${styles['valign-text-middle']}`} style={{"width":"250px"}}>{item.itemUnitQuantity}</div>
                                        </div>
                                    </div>
                                    <div className={styles['table-body-item']}></div>
                                </div>
                                <div className={`${styles['background-1']} ${styles['background-3']}`}></div>
                            </div>
                            <div className={styles['flex-row-1']}>
                                <div className={`${styles['background-2']} ${styles['background-3']}`}></div>
                                <div className={`${styles['text-17']} ${styles['valign-text-middle']}`}>상품 정보 고시</div>
                            </div>
                            <div className={styles['frame-101']}>
                                <div className={styles['frame-99']}>
                                    <div className={styles['frame-97']}>
                                        <div className={`${styles['text-18']} ${styles['valign-text-middle']} ${styles['notosanskr-medium-black-16px']}`}>
                                            카테고리
                                        </div>
                                    </div>
                                    <div className={styles['frame-98']}>
                                        <div className={`${styles['text-19']} ${styles['valign-text-middle']}`}>{`${item.itemMajorCategoryName}/${item.itemMiddleCategoryName}/${item.itemSubCategoryName}`}</div>
                                    </div>
                                </div>
                                <div className={styles['frame-100']}>
                                    <div className={styles['frame-97']}>
                                        <div className={`${styles['text-20']} ${styles['valign-text-middle']} ${styles['notosanskr-medium-black-16px']}`}>
                                            원산지
                                        </div>
                                    </div>
                                    <div className={styles['frame-98']}>
                                        <div className={`${styles['text-21']} ${styles['valign-text-middle']}`}>{item.itemCountryOrigin}</div>
                                    </div>
                                </div>
                            </div>
                        </div>
