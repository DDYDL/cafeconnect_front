                                ...
                                <div className={`${styles['table-body']} ${styles['notosanskr-medium-black-16px']}`}>
                                    ...
                                    <div className={styles['table-body-item']}>
                                        ...
                                        <div className={`${styles['data-1']} ${styles['data-5']}`}>
                                            <div className={`${styles['g2000002676']} ${styles['valign-text-middle']}`}>G2000002676</div>
                                        </div>
                                    </div>
                                    <div className={styles['table-body-item']}>
                                        <div className={`${styles['data']} ${styles['valign-text-middle']}`}>공급가</div>
                                        <div className={`${styles['data-1']} ${styles['data-5']}`}>
                                            <div className={`${styles['text-14']} ${styles['valign-text-middle']}`}>5,900원</div>
                                        </div>
                                    </div>
                                    <div className={styles['table-body-item']}>
                                    ...
                                    <div className={styles['table-body-item']}>
                                        ...
                                        <div className={`${styles['data-1']} ${styles['data-5']}`}>
                                            <div className={`${styles['text-15']} ${styles['valign-text-middle']}`}>실온</div>
                                        </div>
                                    </div>
                                    <div className={styles['table-body-item']}>
                                    ...
                                    <div className={styles['table-body-item']}>
                                        ...
                                        <div className={`${styles['data-4']} ${styles['data-5']}`}>
                                            <div className={`${styles['text-16']} ${styles['valign-text-middle']}`}>-</div>
                                        </div>
                                    </div>
                                    <div className={styles['table-body-item']}>
                            ...
                            <div className={styles['frame-101']}>
                                <div className={styles['frame-99']}>
                                    ...
                                    <div className={styles['frame-98']}>
                                        <div className={`${styles['text-19']} ${styles['valign-text-middle']}`}>분말가공/파우더/-</div>
                                    </div>
                                </div>
                                <div className={styles['frame-100']}>
                                    ...
                                    <div className={styles['frame-98']}>
                                        <div className={`${styles['text-21']} ${styles['valign-text-middle']}`}>대한민국</div>
                                    </div>
                                </div>
                            </div>
                        </div>
