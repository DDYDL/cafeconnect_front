...
const Quarterly = ({ menu, analyzeData }) => {
  ...
  useEffect(() => {
    ...
    if (analyzeData !== null) {
      const quart = analyzeData[Object.keys(analyzeData)[4]];
      let count = 0,
        amount = 0;
      quart.forEach(s => {
        count += s.salesCount;
                ...
                <SalesTable>
                  <thead>
                    <TableRow style={{ backgroundColor: "#DEDEDE", border: "solid 1px lightgray" }}>
                      ...
                      <TableColumn2 style={{ border: "solid 1px lightgray" }} rowSpan={2}>
                        전년분기대비
                      </TableColumn2>
                    </TableRow>
                        ...
                        .map(data => (
                          <TableRow key={data.menuCode}>
                            ...
                            <TableCell>
                              ...
                              analyzeData[Object.keys(analyzeData)[0]].find(
                                d => d.menuCode === data.menuCode
                              ) === undefined
                                ? "-"
                                : (
