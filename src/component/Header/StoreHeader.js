...
import { DialogBody, DialogHeader, Menu, MenuHandler, MenuItem } from "@material-tailwind/react";
    ...
    <div>
      <h.Div className="navbar">
        ...
        <h.DivSide>
          ...
          <h.VerticalLine />
          <h.NavLinkSide to="/logout" onClick={logout}>
            로그아웃
          </h.NavLinkSide>
        </h.DivSide>
        ...
        <h.DivMenu>
          ...
          >
            ...
            <h.MenuListOut>
              <h.MenuListDiv>
                <MenuItem>
                  <NavLink to="/shopMain">쇼핑몰</NavLink>
                </MenuItem>
              </h.MenuListDiv>
              <h.MenuListDiv>
                <MenuItem>
                  <NavLink to="/stockOrderItemAdd">주문상품재고추가</NavLink>
                </MenuItem>
                <MenuItem>
                  <NavLink to="/stockManage">매장재고관리</NavLink>
                </MenuItem>
                <MenuItem>
                  <NavLink to="/stockOtherStore">타매장재고조회</NavLink>
                </MenuItem>
              </h.MenuListDiv>
              <h.MenuListDiv>
                <MenuItem>
              ...
              <h.MenuListDiv>
                <MenuItem>
                  <NavLink to="/salesWrite">매출입력</NavLink>
                </MenuItem>
                <MenuItem>
                  <NavLink to="/salesAnalysis">매출분석</NavLink>
                </MenuItem>
                <MenuItem>
                  <NavLink to="/expenseList">지출내역</NavLink>
                </MenuItem>
              </h.MenuListDiv>
              <h.MenuListDiv>
                <MenuItem>
                ...
                <MenuItem>
                  <NavLink to="/complainList">컴플레인 공지</NavLink>
                </MenuItem>
                <MenuItem>
                  <NavLink to="/askListStore">1:1 문의</NavLink>
                </MenuItem>
              </h.MenuListDiv>
              <h.MenuListDiv>
                <MenuItem>
                  <NavLink to="/myAlarmList">알림 모아보기</NavLink>
                </MenuItem>
                <MenuItem>
                  <NavLink to="/myStoreInfo">가맹점 정보</NavLink>
                </MenuItem>
                <MenuItem>
                  <NavLink to="/myStoreManage">내 가맹점 관리</NavLink>
                </MenuItem>
              </h.MenuListDiv>
            </h.MenuListOut>
          </Menu>
        ...
        <h.DivIcon>
          ...
          <h.NavLinkIcon to="/repairRequestList">
            <h.Icon src="/repair.png" />
          </h.NavLinkIcon>
          <h.NavLinkIcon to="/wishList">
            <h.Icon src="/wish.png" />
          </h.NavLinkIcon>
          <h.NavLinkIcon to="/cartList">
            <h.Icon src="/cart.png" />
          </h.NavLinkIcon>
        </h.DivIcon>
      </h.Div>
            ...
            {alarms.length === 0 ? (
              ...
              alarms.map(item => (
                <m.AlarmDiv key={item.alarmNum} width="100%" height="130px">
                  <m.AlarmCheckboxDiv>
                    <m.AlarmCheckbox onChange={e => alarmConfirm(item.alarmNum)} />
                  </m.AlarmCheckboxDiv>
                  <m.AlarmInnerDiv>
                    <m.AlarmSpan>{item.alarmType}</m.AlarmSpan>
                    <h.VerticalLine marginRight="10px" />
                    <m.AlarmSpan fontWeight="normal" fontColor="rgba(148, 148, 148, 1)">
                      {item.alarmDate}
                    </m.AlarmSpan>
                  </m.AlarmInnerDiv>
